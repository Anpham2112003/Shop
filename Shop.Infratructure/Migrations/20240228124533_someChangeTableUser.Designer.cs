...
namespace Shop.Infratructure.Migrations
{
    ...
    [Migration("20240228124533_someChangeTableUser")]
    partial class someChangeTableUser
    {
            ...
            modelBuilder.Entity("Shop.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("72a3de04-a798-45e3-9b43-fc7adb95f675"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("7044630a-e18e-433e-a689-7157df0f07bf"),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("ae5135d0-754a-4fc3-af0b-56ff2117a46d"),
                            Name = "User"
                        });
                });
